...
(function($) {
    ...
    $.extend($.fn.addTouch = function() {
        ...
        var handleTouch = function(event) {
            ...
            for (var i = 0; i < type.length; i++) {
                ...
                simulatedEvent.initMouseEvent(type[i], true, true, window, 1, first.screenX, first.screenY, first.clientX, first.clientY, false, false, false, false, 0, null);
    ...
    function VirtualSky(input) {
        ...
        this.spin = false;
        this.cardinalpoints = true;
        this.constellation = {
            lines: false,
            boundaries: false,
            labels: false
        };
        this.meteorshowers = false;
        this.negative = false;
        this.showgalaxy = false;
        this.showstars = true;
        this.showstarlabels = false;
        this.showplanets = true;
        this.showplanetlabels = true;
        ...
        this.projections = {
            ...
            fisheye: {
                ...
                azel2xy: function(az, el, w, h) {
                    var radius = h / 2;
                    var r = radius * Math.sin(((Math.PI / 2) - el) / 2) / 0.70710678;
                    return {
                        x: (w / 2 - r * Math.sin(az)),
                        y: (radius - r * Math.cos(az)),
                        el: el
            ...
            gnomic: {
                ...
                radec2xy: function(ra, dec, coords) {
                    ...
                    if (Math.abs(dec - this.dc_off) > this.maxangle) {
                        return {
                            x: -1,
                            y: -1,
                            el: -1
                    ...
                    if (this.ground && coords[0] < -0.000001) {
                        return {
                            x: -1,
                            y: -1,
        ...
        this.stars = this.convertStarsToRadians([
            [677, 2.07, 2.097, 29.09],
            [746, 2.28, 2.295, 59.15],
            [765, 3.88, 2.353, -45.75],
            [1067, 2.83, 3.309, 15.18],
            [1562, 3.56, 4.857, -8.82],
            [1599, 4.23, 5.018, -64.87],
            [1645, 5.38, 5.149, 8.19],
            [2021, 2.82, 6.438, -77.25],
            [2072, 3.93, 6.551, -43.68],
            [2081, 2.4, 6.571, -42.31],
            [2484, 4.36, 7.886, -62.96],
            [2920, 3.69, 9.243, 53.9],
            [3092, 3.27, 9.832, 30.86],
            [3179, 2.24, 10.127, 56.54],
            [3419, 2.04, 10.897, -17.99],
            [3760, 5.92, 12.073, 7.3],
            [3821, 3.46, 12.276, 57.82],
            [3881, 4.53, 12.454, 41.08],
            [4427, 2.15, 14.177, 60.72],
            [4436, 3.86, 14.188, 38.5],
            [4577, 4.3, 14.652, -29.36],
            [4889, 5.5, 15.705, 31.8],
            [4906, 4.27, 15.736, 7.89],
            [5165, 3.32, 16.521, -46.72],
            [5348, 3.94, 17.096, -55.25],
            [5364, 3.46, 17.147, -10.18],
            [5447, 2.07, 17.433, 35.62],
            [5742, 4.67, 18.437, 24.58],
            [6193, 4.74, 19.867, 27.26],
            [6537, 3.6, 21.006, -8.18],
            [6686, 2.66, 21.454, 60.24],
            [6867, 3.41, 22.091, -43.32],
            [7007, 4.84, 22.546, 6.14],
            [7083, 3.93, 22.813, -49.07],
            [7097, 3.62, 22.871, 15.35],
            [7588, 0.45, 24.429, -57.24],
            [7607, 3.59, 24.498, 48.63],
            [7884, 4.45, 25.358, 5.49],
            [8102, 3.49, 26.017, -15.94],
            [8198, 4.26, 26.348, 9.16],
            [8645, 3.74, 27.865, -10.34],
            [8796, 3.42, 28.27, 29.58],
            [8832, 3.88, 28.383, 19.29],
            [8833, 4.61, 28.389, 3.19],
            [8837, 4.39, 28.411, -46.3],
            [37826, 1.16, 116.329, 28.03],
            [38146, 5.32, 117.257, -24.91],
            [38170, 3.34, 117.324, -24.86],
            [38414, 3.71, 118.054, -40.58],
            [38827, 3.46, 119.195, -52.98],
            [39429, 2.21, 120.896, -40],
            [39757, 2.83, 121.886, -24.3],
            [39794, 4.35, 121.982, -68.62],
            [39863, 4.36, 122.149, -2.98],
            [39953, 1.75, 122.383, -47.34],
            [40526, 3.53, 124.129, 9.19],
            [40702, 4.05, 124.631, -76.92],
            [40843, 5.13, 125.016, 27.22],
            [41037, 1.86, 125.628, -59.51],
            [41075, 4.25, 125.709, 43.19],
            [41307, 3.91, 126.415, -3.91],
            [41312, 3.77, 126.434, -66.14],
            [41704, 3.35, 127.566, 60.72],
            [42313, 4.14, 129.414, 5.7],
            [42402, 4.45, 129.689, 3.34],
            [42515, 3.97, 130.026, -35.31],
            [42536, 3.6, 130.073, -52.92],
            [42568, 4.31, 130.154, -59.76],
            [42570, 3.77, 130.157, -46.65],
            [42799, 4.3, 130.806, 3.4],
            [42806, 4.66, 130.821, 21.47],
            [42828, 3.68, 130.898, -33.19],
            [42911, 3.94, 131.171, 18.15],
            [42913, 1.93, 131.176, -54.71],
            [43023, 3.87, 131.507, -46.04],
            [43103, 4.03, 131.674, 28.76],
            [43109, 3.38, 131.694, 6.42],
            [43234, 4.35, 132.108, 5.84],
            [43409, 4.02, 132.633, -27.71],
            [43783, 3.84, 133.762, -60.64],
            [43813, 3.11, 133.848, 5.95],
            [44066, 4.26, 134.622, 11.86],
            [44127, 3.12, 134.802, 48.04],
            [44248, 3.96, 135.16, 41.78],
            [44382, 4, 135.612, -66.4],
            [44471, 3.57, 135.906, 47.16],
            [44511, 3.75, 136.039, -47.1],
            [44700, 4.56, 136.632, 38.45],
            [44816, 2.23, 136.999, -43.43],
            [45080, 3.43, 137.742, -58.97],
            [45101, 3.96, 137.82, -62.32],
            [45238, 1.67, 138.3, -69.72],
            [45336, 3.89, 138.591, 2.31],
            [45556, 2.21, 139.273, -59.28],
            [45688, 3.82, 139.711, 36.8],
            [45860, 3.14, 140.264, 34.39],
            [45941, 2.47, 140.528, -55.01],
            [46390, 1.99, 141.897, -8.66],
            [46509, 4.59, 142.287, -2.77],
            [46651, 3.6, 142.675, -40.47],
            [46701, 3.16, 142.805, -57.03],
            [46733, 3.65, 142.882, 63.06],
            [46776, 4.54, 142.996, -1.18],
            [46853, 3.17, 143.214, 51.68],
            [46952, 4.54, 143.556, 36.4],
            [47431, 3.9, 144.964, -1.14],
            [47508, 3.52, 145.288, 9.89],
            [47854, 3.69, 146.312, -62.51],
            [47908, 2.97, 146.463, 23.77],
            [48002, 2.92, 146.776, -65.07],
            [48319, 3.78, 147.747, 59.04],
            [48356, 4.11, 147.87, -14.85],
            [48402, 4.55, 148.026, 54.06],
            [48455, 3.88, 148.191, 26.01],
            [48774, 3.52, 149.216, -54.57],
            [48926, 5.23, 149.718, -35.89],
            [49583, 3.48, 151.833, 16.76],
            [49593, 4.49, 151.857, 35.24],
            [49641, 4.48, 151.985, -0.37],
            [49669, 1.36, 152.093, 11.97],
            [49841, 3.61, 152.647, -12.35],
            [107354, 4.14, 326.161, 25.65],
            [107556, 2.85, 326.76, -16.13],
            [107608, 5.02, 326.934, -30.9],
            [108085, 3, 328.482, -37.36],
            [108661, 5.43, 330.209, -28.45],
            [109074, 2.95, 331.446, -0.32],
            [109111, 4.47, 331.529, -39.54],
            [109139, 4.29, 331.609, -13.87],
            [109176, 3.77, 331.753, 25.35],
            [109268, 1.73, 332.058, -46.96],
            [109352, 5.58, 332.307, 33.17],
            [109422, 4.94, 332.537, -32.55],
            [109427, 3.52, 332.55, 6.2],
            [109492, 3.39, 332.714, 58.2],
            [109937, 4.14, 333.992, 37.75],
            [110003, 4.17, 334.208, -7.78],
            [110130, 2.87, 334.625, -60.26],
            [110395, 3.86, 335.414, -1.39],
            [110538, 4.42, 335.89, 52.23],
            [110609, 4.55, 336.129, 49.48],
            [110960, 3.65, 337.208, -0.02],
            [110997, 3.97, 337.317, -43.5],
            [111022, 4.34, 337.383, 47.71],
            [111104, 4.52, 337.622, 43.12],
            [111123, 4.82, 337.662, -10.68],
            [111169, 3.76, 337.823, 50.28],
            [111188, 4.29, 337.876, -32.35],
            [111497, 4.04, 338.839, -0.12],
            [111954, 4.18, 340.164, -27.04],
            [112029, 3.41, 340.366, 10.83],
            [112122, 2.07, 340.667, -46.88],
            [112158, 2.93, 340.751, 30.22],
            [112405, 4.13, 341.515, -81.38],
            [112440, 3.97, 341.633, 23.57],
            [112447, 4.2, 341.673, 12.17],
            [112623, 3.49, 342.139, -51.32],
            [112716, 4.05, 342.398, -13.59],
            [112724, 3.5, 342.42, 66.2],
            [112748, 3.51, 342.501, 24.6],
            [112961, 3.73, 343.154, -7.58],
            [113136, 3.27, 343.663, -15.82],
            [113246, 4.2, 343.987, -32.54],
            [113368, 1.17, 344.413, -29.62],
            [113638, 4.11, 345.22, -52.75],
            [113726, 3.62, 345.48, 42.33],
            [113881, 2.44, 345.944, 28.08],
            [113963, 2.49, 346.19, 15.21],
            [114131, 4.28, 346.72, -43.52],
            [114341, 3.68, 347.362, -21.17],
            [114421, 3.88, 347.59, -45.25],
            [114855, 4.24, 348.973, -9.09],
            [114971, 3.7, 349.291, 3.28],
            [114996, 3.99, 349.357, -58.24],
            [115102, 4.41, 349.706, -32.53],
            [115438, 3.96, 350.743, -20.1],
            [115738, 4.95, 351.733, 1.26],
            [115830, 4.27, 351.992, 6.38],
            [116231, 4.38, 353.243, -37.82],
            [116584, 3.81, 354.391, 46.46],
            [116727, 3.21, 354.837, 77.63],
            [116771, 4.13, 354.988, 5.63],
            [116928, 4.49, 355.512, 1.78],
        ...
        this.dir = $("script[src*=virtualsky]").attr("src").match(/^.*\//);
        this.dir = this.dir && this.dir[0] || "";
        this.file = {
            ...
            planets: this.dir + "virtualsky-planets.min.js"
        };
        this.hipparcos = {};
        this.clock = new Date();
        this.fullsky = false;
        ...
        this.input = input;
        this.init(input);
        if (typeof this.polartype == "undefined") {
            this.selectProjection("polar")
        }
        this.updateColours();
        ...
        function bs() {
            return "box-shadow:0px 0px 20px rgba(255,255,255,0.5);"
        }
        r = br("0.5em");
        s = br("3px");
    ...
    VirtualSky.prototype.init = function(d) {
        ...
        if (is(d.projection, s)) {
            this.selectProjection(d.projection)
        }
        if (is(d.constellations, b)) {
            this.constellation.lines = d.constellations
        }
        if (is(d.constellationboundaries, b)) {
            this.constellation.boundaries = d.constellationboundaries
        }
        if (is(d.constellationlabels, b)) {
            this.constellation.labels = d.constellationlabels
        }
        if (is(d.gridlines_az, b)) {
            this.grid.az = d.gridlines_az
        }
        if (is(d.gridlines_eq, b)) {
            this.grid.eq = d.gridlines_eq
        }
        if (is(d.gridlines_gal, b)) {
            this.grid.gal = d.gridlines_gal
        }
        if (is(d.gridstep, n)) {
            this.grid.step = d.gridstep
        }
        if (is(d.longitude, n)) {
            this.setLongitude(d.longitude)
        }
        if (is(d.latitude, n)) {
            this.setLatitude(d.latitude)
        }
        if (is(d.clock, s)) {
            this.clock = new Date(d.clock.replace(/%20/g, " "))
        }
        if (is(d.az, n)) {
            this.az_off = (d.az % 360) - 180
        }
        if (is(d.ra, n)) {
            this.setRA(d.ra)
        }
        ...
        if (is(d.planets, s)) {
            this.file.planets = d.planets
        }
        if (is(d.planets, o)) {
            this.planets = d.planets
        }
        if (is(d.lines, s)) {
            this.file.lines = d.lines
        }
        if (is(d.lines, o)) {
            this.lines = d.lines
        }
        if (is(d.boundaries, s)) {
            this.file.boundaries = d.boundaries
        }
        if (is(d.boundaries, o)) {
            this.boundaries = d.boundaries
        }
        if (is(d.width, n)) {
            this.wide = d.width
        }
        ...
        if (is(d.lang, s) && d.lang.length == 2) {
            this.language = d.lang
        }
        if (is(d.fontfamily, s)) {
            this.fntfam = d.fontfamily.replace(/%20/g, " ")
        }
        if (is(d.fontsize, s)) {
            this.fntsze = d.fontsize
        }
        if (is(d.callback, o)) {
            if (is(d.callback.geo, f)) {
                this.callback.geo = d.callback.geo
            }
            if (is(d.callback.mouseenter, f)) {
                this.callback.mouseenter = d.callback.mouseenter
            }
            if (is(d.callback.mouseout, f)) {
                this.callback.mouseout = d.callback.mouseout
            }
        }
        return this
    };
    VirtualSky.prototype.loadLanguage = function(l, fn) {
        ...
        this.loadJSON(url, function(data) {
            ...
            for (var i = 0; i < this.langs.length; i++) {
                if (this.langs[i].language && this.langs[i].language.code == l) {
                    found = i
                }
            }
            if (found < 0) {
            ...
            if (url.indexOf(this.language) > 0) {
    ...
    VirtualSky.prototype.setWH = function(w, h) {
        ...
        this.tall = h;
        this.changeFOV();
        if (this.ie && $.browser.version == 8) {
            $("#" + this.idinner).find("div").css({
                width: w,
                height: h
            })
        }
        ...
        if (dt == "script") {
            ...
            callback = function(data) {
                for (var i = 0; i < this.plugins.length; ++i) {
                    if (typeof this.plugins[i].init == "function") {
    ...
    VirtualSky.prototype.createSky = function() {
        ...
        if (!this.planets) {
            this.load("planets", this.file.planets)
        }
        if (!this.lines) {
            this.load("lines", this.file.lines)
        }
        if (!this.boundaries) {
            this.load("boundaries", this.file.boundaries)
        }
        if (!this.showers) {
            this.load("showers", this.file.showers)
        }
        if (!this.galaxy) {
            this.load("galaxy", this.file.galaxy)
        }
        ...
        if (this.c && this.c.getContext) {
            ...
            $("#" + this.idinner).on("click", {
                ...
                s.x = "";
                s.y = "";
                if (typeof s.callback.mouseout == "function") {
                    s.callback.mouseout.call(s)
                }
            }).on("mouseenter", {
                sky: this
            }, function(e) {
                var s = e.data.sky;
                s.mouseover = true;
                if (typeof s.callback.mouseenter == "function") {
                    s.callback.mouseenter.call(s)
                }
            }).on("mousewheel", {
                sky: this
            }, function(e, delta) {
    ...
    VirtualSky.prototype.toggleHelp = function() {
        var v = "virtualsky";
        if ($("." + v + "_dismiss").length > 0) {
            $("." + v + "_dismiss").trigger("click")
        } else {
            var o = "";
            for (var i = 0; i < this.keys.length; i++) {
                if (this.keys[i].txt) {
                    o += '<li><strong class="' + v + "_help_key " + v + "_" + this.keys[i].txt + '">' + this.keys[i].str + '</strong> &rarr; <a href="#" class="' + v + "_" + this.keys[i].txt + '" style="text-decoration:none;">' + this.getPhrase(this.keys[i].txt) + "</a></li>"
                }
            }
    ...
    VirtualSky.prototype.registerKey = function(charCode, fn, txt) {
        ...
        for (c = 0; c < charCode.length; c++) {
            ...
            for (i = 0; i < this.keys.length; i++) {
                if (this.keys.charCode == ch && this.keys.altKey == alt) {
                    aok = false
                }
            }
            if (aok) {
        ...
        if (this.projections[proj]) {
            ...
            if (typeof this.projection.azel2radec === "function") {
                ...
                this.azel2radec = function(az, el) {
                    ...
                    xt *= this.r2d;
                    yt *= this.r2d;
                    yt = (this.times.LST * 15 - yt + 360) % 360;
                    return {
                        ra: yt,
                        dec: xt
                    }
            ...
            if (this.container) {
                ...
                if ($("." + this.id + "_projection").length > 0) {
                    $("." + this.id + "_projection").remove()
                }
    ...
    VirtualSky.prototype.cycleProjection = function() {
        ...
        for (var key in this.projections) {
            ...
            if (key == this.projection.id) {
                usenext = true
            }
            i++
        }
        if (proj == this.projection.id) {
            proj = firstkey
        }
        this.draw(proj)
    };
    ...
    VirtualSky.prototype.isVisible = function(el) {
        if (typeof this.projection.isVisible === "function") {
            return this.projection.isVisible.call(el)
        }
        if (!this.fullsky) {
            return (el > 0)
        } else {
            return (this.ground) ? (el > 0) : true
        }
    };
    ...
    VirtualSky.prototype.meanObliquity = function(JD) {
        ...
        T2 = T * T;
        T3 = T2 * T;
        return (23.4392917 - 0.0130041667 * T - 1.6667e-7 * T2 + 5.027778e-7 * T3) * this.d2r
    };
    ...
    VirtualSky.prototype.ecliptic2xy = function(l, b, LST) {
        ...
        if (typeof this.projection.ecliptic2xy === "function") {
            return this.projection.ecliptic2xy.call(this, l, b, LST)
        } else {
            if (this.fullsky) {
    ...
    VirtualSky.prototype.radec2xy = function(ra, dec) {
        if (typeof this.projection.radec2xy === "function") {
            return this.projection.radec2xy.call(this, ra, dec)
        } else {
            var coords = this.coord2horizon(ra, dec);
            if (coords[0] > 0) {
    ...
    VirtualSky.prototype.gal2radec = function(l, b) {
        return this.Transform([l, b], [-0.054875539726, 0.494109453312, -0.867666135858, -0.87343710801, -0.444829589425, -0.198076386122, -0.483834985808, 0.74698225181, 0.455983795705], false)
    };
    ...
    VirtualSky.prototype.updateSkyGradient = function() {
        ...
        if (this.ctx && this.hasGradient()) {
            if (this.projection.polartype) {
                ...
                s.addColorStop(0, "rgba(0,30,50,0.1)");
    ...
    VirtualSky.prototype.draw = function(proj) {
        ...
        if (this.polartype) {
            ...
            if (typeof this.projection.draw === "function") {
                this.projection.draw.call(this)
            }
        }
        if (this.hasGradient()) {
        ...
        if (this.showhelp) {
            ...
            if (d.find("." + this.id + "_help").length == 0) {
                d.append('<div class="' + this.id + '_help"><a href="#">' + helpstr + "</a></div>").find("." + this.id + "_help").css({
                    position: "absolute",
                    padding: 5,
                    zIndex: 20,
                    display: "block",
        ...
        $("." + this.id + "_position").css({
            ...
            if (typeof s.callback.geo == "function") {
                s.callback.geo.call(s)
            }
        });
        return this
    };
    VirtualSky.prototype.lightbox = function(lb) {
        ...
        columize.call(this);
        var n = "virtualsky_bg";
        if (this.container.find("." + n).length == 0) {
            this.container.append('<div class="' + n + '" style="position:absolute;z-index: 99;left:0px;top: 0px;right: 0px;bottom: 0px;background-color: rgba(0,0,0,0.7);"></div>')
        }
    ...
    VirtualSky.prototype.drawStars = function() {
        if (!this.showstars && !this.showstarlabels) {
            return this
        }
        ...
        if (typeof this.scalestars === "number" && this.scalestars != 1) {
            f *= this.scalestars
        }
        if (this.projection.id === "gnomic") {
            f *= fovf
        }
            ...
            if (this.stars[i][1] < this.magnitude) {
                ...
                if (this.isVisible(p.el) && !isNaN(p.x) && !this.isPointBad(p)) {
                    ...
                    if (this.showstarlabels && this.starnames[this.stars[i][0]]) {
                        this.drawLabel(p.x, p.y, d, "", this.starnames[this.stars[i][0]])
                    }
                }
            }
        }
    ...
    VirtualSky.prototype.drawPlanets = function() {
        if (!this.showplanets && !this.showplanetlabels && !this.showorbits) {
            return this
        }
    ...
    VirtualSky.prototype.drawLabel = function(x, y, d, colour, label) {
        ...
        c.lineWidth = 1.5;
        var xoff = d;
        if ((this.polartype) && c.measureText) {
            xoff = -c.measureText(label).width - 3
        }
        if ((this.polartype) && x < this.wide / 2) {
            xoff = d
        }
    ...
    VirtualSky.prototype.drawConstellationLines = function(colour) {
        if (!(this.constellation.lines || this.constellation.labels)) {
            return this
        }
        if (!colour) {
    ...
    VirtualSky.prototype.drawConstellationBoundaries = function(colour) {
        ...
        if (!colour) {
            colour = this.col.constellationboundary
        }
        this.ctx.beginPath();
        this.ctx.strokeStyle = colour;
        this.ctx.fillStyle = colour;
        this.ctx.lineWidth = 0.75;
        if (typeof this.boundaries !== "object") {
            return this
        }
        ...
        if (!this.constellation.bpts) {
            this.constellation.bpts = new Array(this.boundaries.length)
        }
        var cbdone = [];
        if (this.constellation.boundaries) {
    ...
    VirtualSky.prototype.drawGalaxy = function(colour) {
        if (!this.galaxy || !this.showgalaxy) {
            return this
        }
        if (!colour) {
            colour = this.col.galaxy
        }
        this.ctx.beginPath();
        this.ctx.strokeStyle = colour;
        this.ctx.fillStyle = colour;
        ...
        for (c = 0; c < this.galaxy.length; c++) {
            if (!this.galaxyprocessed) {
                for (i = 1; i < this.galaxy[c].length; i++) {
                    this.galaxy[c][i] *= this.d2r
                }
            }
    ...
    VirtualSky.prototype.drawMeteorShowers = function(colour) {
        if (!this.meteorshowers || typeof this.showers === "string") {
            return this
        }
        if (!colour) {
            colour = this.col.showers
        }
    ...
    VirtualSky.prototype.drawEcliptic = function(colour) {
        ...
        for (var a = 0; a < Math.PI * 2; a += step) {
            old = joinpoint(this, "ec", a, 0, old, maxl)
        }
        c.stroke();
        return this
    };
    VirtualSky.prototype.drawMeridian = function(colour) {
        ...
        for (b = minb, a = 0; b <= maxb; b += step) {
            old = joinpoint(this, "az", Math.PI, b, old, maxl)
        }
        for (b = maxb, a = 0; b >= minb; b -= step) {
            old = joinpoint(this, "az", 0, b, old, maxl)
        }
        c.stroke();
        return this
    };
    VirtualSky.prototype.drawGridlines = function(type, step, colour) {
        if (!type || !this.grid[type]) {
            return this
        }
        if (typeof colour !== "string") {
            colour = this.col[type]
        }
        ...
        for (a = 0; a < Math.PI * 2; a += step) {
            ...
            for (b = minb; b <= maxb; b += bstep) {
                old = joinpoint(this, type, a, b, old, maxl)
            }
        }
        c.stroke();
        c.beginPath();
    ...
    VirtualSky.prototype.highlight = function(i, colour) {
        ...
        if (this.pointers[i].ra && this.pointers[i].dec) {
            ...
            if (this.negative) {
                colour = this.getNegative(colour)
            }
    ...
    function joinpoint(s, type, a, b, old, maxl) {
        ...
        c = s.ctx;
        if (type == "az") {
            pos = s.azel2xy((a - s.az_off * s.d2r), b, s.wide, s.tall)
        } else {
            if (type == "eq") {
                pos = s.radec2xy(a, b)
            } else {
                if (type == "ec") {
                    pos = s.ecliptic2xy(a, b, s.times.LST)
                } else {
                    if (type == "gal") {
                        pos = s.gal2xy(a, b)
                    }
        ...
        if (type == "az") {
            ...
            show = ((s.isVisible(pos.el)) ? true : false)
        }
    ...
    VirtualSky.prototype.panTo = function(ra, dec, s) {
        ...
        if (this.panning.dr > 180) {
            this.panning.dr = -(360 - this.panning.dr)
        }
        if (this.panning.dr < -180) {
            this.panning.dr = (360 + this.panning.dr)
        }
    ...
    VirtualSky.prototype.toggleAzimuthMove = function(az) {
        if (this.az_step === 0) {
            ...
            this.az_step = 0;
            if (this.timer_az !== undefined) {
                clearTimeout(this.timer_az)
            }
        }
        return this
    };
    VirtualSky.prototype.addPointer = function(input) {
        ...
        var p;
        for (var i = 0; i < this.pointers.length; i++) {
            if (this.pointers[i].ra == input.ra && this.pointers[i].dec == input.dec && this.pointers[i].label == input.label) {
                matched = i
            }
        }
        if (matched < 0) {
    ...
    VirtualSky.prototype.spinIt = function(tick, wait) {
        if (typeof tick === "number") {
            this.spin = (tick == 0) ? 0 : (this.spin + tick)
        } else {
            var t = 1 / this.fps;
            var s = 2;
            if (this.spin == 0) {
                this.spin = (tick == "up") ? t : -t
            } else {
                if (Math.abs(this.spin) < 1) {
                    s *= 2
                }
                if (this.spin > 0) {
                    this.spin = (tick == "up") ? (this.spin * s) : (this.spin / s)
                } else {
                    if (this.spin < 0) {
                        this.spin = (tick == "up") ? (this.spin / s) : (this.spin * s)
                    }
                }
                if (this.spin < t && this.spin > -t) {
                    this.spin = 0
                }
            }
        }
    ...
    VirtualSky.prototype.getJD = function(clock) {
        ...
        return (clock.getTime() / 86400000) + 2440587.5
    };
