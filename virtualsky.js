...
VirtualSky.prototype.load = function(t,file,fn){
	return this.loadJSON(file,function(data){
		if(t=="stars"){ this.starsdeep = true; this.stars = this.stars.concat(data.stars);}
		else{ this[t] = data[t]; }
		this.draw();
	},fn);
}
...
VirtualSky.prototype.drawStars = function(){
	...
	for(i = 0; i < this.stars.length; i++){
		if(this.stars[i][1] < this.magnitude){
			mag = this.stars[i][1];
			p = this.radec2xy(this.stars[i][2]*this.d2r, this.stars[i][3]*this.d2r);
		...
		if(this.constellation.lines){
			for(l = 3; l < this.lines[c].length; l+=2){
				...
				if(a >= 0 && b >= 0 && a < this.stars.length && b < this.stars.length){
					posa = this.radec2xy(this.stars[a][2]*this.d2r, this.stars[a][3]*this.d2r);
					posb = this.radec2xy(this.stars[b][2]*this.d2r, this.stars[b][3]*this.d2r);
